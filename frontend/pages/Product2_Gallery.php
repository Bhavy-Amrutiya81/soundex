...
if (!$product) {
    ...
    $product = !empty($products) ? $products[1] : null;
...
<body>
  ...
  <div style="padding: 120px 20px 40px 20px; min-height: calc(100vh - 160px);">
    ...
    <div class="product-details">
      ...
      <p class="description">
        <?php echo htmlspecialchars($product['description'] ?? 'Compact wireless speaker with crystal clear sound and long battery backup.'); ?>
      </p>
