...
<head>
    ...
    <title>Portable Speakers - Soundex</title>
...
<body>
        ...
        <section class="product-section">
            <div class="product-container">
                <div class="product-image">
                    <a href="../pages/product_detail.php"><img src="<?php echo htmlspecialchars($product['image_url'] ?? '../assets/images/product_gallery/1.jpg'); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';"></a>
                </div>
    ...
    <?php else: ?>
        <section class="product-section">
            <div class="product-container">
                <div class="product-image">
                    <a href="../pages/product_detail.php"><img src="../assets/images/product_gallery/1.jpg" alt="Product Image" onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';"></a>
                </div>
                <div class="product-details">
        ...
        <section class="product-section">
            <div class="product-container">
                ...
                <div class="product-details">
                    ...
                    <p>This is an awesome product that you can buy today. It has excellent features and is a must-have!</p>
                    <p class="price">₹2999</p>
                    <button class="buy-btn" data-product-name="Soundcore Motion 300" data-product-price="2999">Buy Now</button>
                </div>
            </div>
        </section>
        <section class="product-section">
            <div class="product-container">
                ...
                <div class="product-details">
                    ...
                    <p>This is an awesome product that you can buy today. It has excellent features and is a must-have!</p>
                    <p class="price">₹2999</p>
                    <button class="buy-btn" data-product-name="Denon Envaya DSB-250BT" data-product-price="2999">Buy Now</button>
                </div>
            </div>
        </section>
        <section class="product-section">
            <div class="product-container">
                ...
                <div class="product-details">
                    ...
                    <p>This is an awesome product that you can buy today. It has excellent features and is a must-have!</p>
                    <p class="price">₹2999</p>
                    <button class="buy-btn" data-product-name="Marshall MIDDLETON" data-product-price="2999">Buy Now</button>
                </div>
            </div>
        </section>
        <section class="product-section">
            <div class="product-container">
                <div class="product-image">
                    <img src="../assets/images/product_gallery/42.jpg" alt="Product Image" onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                </div>
                <div class="product-details">
                    <h2>Marshall Acton Bluetooth speaker</h2>
                    <p>This is an awesome product that you can buy today. It has excellent features and is a must-have!</p>
                    <p class="price">₹2999</p>
                    <button class="buy-btn" data-product-name="Marshall Acton Bluetooth speaker" data-product-price="2999">Buy Now</button>
                </div>
            </div>
        </section>
        <section class="product-section">
            <div class="product-container">
                <div class="product-image">
                    <img src="../assets/images/product_gallery/30.jpg" alt="Product Image" onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                </div>
                <div class="product-details">
                    <h2>JBL Clip-4</h2>
                    <p>This is an awesome product that you can buy today. It has excellent features and is a must-have!</p>
                    <p class="price">₹2999</p>
                    <button class="buy-btn" data-product-name="JBL Clip-4" data-product-price="2999">Buy Now</button>
                </div>
            </div>
        </section>
        <section class="product-section">
            <div class="product-container">
                <div class="product-image">
                    <img src="../assets/images/product_gallery/27.jpg" alt="Product Image" onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                </div>
                <div class="product-details">
                    <h2>Sony PUMPX (SRS-X2)</h2>
                    <p>This is an awesome product that you can buy today. It has excellent features and is a must-have!</p>
                    <p class="price">₹2999</p>
                    <button class="buy-btn" data-product-name="Sony PUMPX (SRS-X2)" data-product-price="2999">Buy Now</button>
                </div>
            </div>
        </section>
        <section class="product-section">
            <div class="product-container">
                <div class="product-image">
                    <img src="../assets/images/product_gallery/24.jpg" alt="Product Image" onerror="this.onerror=null; this.src='../assets/images/product_gallery/1.jpg';">
                </div>
                <div class="product-details">
                    <h2> pTron Fusion Go 10W</h2>
                    <p>This is an awesome product that you can buy today. It has excellent features and is a must-have!</p>
                    <p class="price">₹2999</p>
                    <button class="buy-btn" data-product-name="pTron Fusion Go 10W" data-product-price="2999">Buy Now</button>
                </div>
            </div>
        </section>
    <?php endif; ?>
